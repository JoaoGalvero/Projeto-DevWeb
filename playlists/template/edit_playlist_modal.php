<div class="modal fade" id="edit-playlist-modal" tabindex="-1" aria-labelledby="playlistModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="playlistModalLabel">Editar Playlist</h5>
			...
			<form id="playlist-form" action="../url.php" method="POST" enctype="multipart/form-data">
				...
				<div class="modal-body">
					<div class="mb-3">
						...
						<input type="text" class="form-control" id="edit-name" name="name" placeholder="Digite o nome">
					</div>
					<div class="mb-3">
					...
					<div class="mb-3">
						...
						<textarea class="form-control" id="edit-description" name="description" rows="3" placeholder="Escreva algo sobre a playlist..."></textarea>
					</div>
				</div>
...
function openEditModal(playlist) {
    ...
    document.getElementById("edit-description").value = playlist.description;

    new bootstrap.Modal(document.getElementById("edit-playlist-modal")).show();
}
</script>
