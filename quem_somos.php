    ...
    <main>
        <div class="media-player-wrapper">
            ...
            <section>
                ...
                <p>O site funciona como uma biblioteca de playlists, <br>oferecendo um espaço leve e focado na curadoria individual, onde cada usuário constrói seu próprio acervo sonoro.</p>
            </section>
        </div>
    </main>
